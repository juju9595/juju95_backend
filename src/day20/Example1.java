...
public class Example1 {//class s
    ...
    public static void main(String[] args) {
        ...
        - 타입 : 값 분류하는 종류
            1. 기본타입:8가지 예) boolean int byte , 리터럴자료 ,  소문자로 시작  , int , 객체지향 아니더라도 존재했었다
                    -> 자바회사에서 제공하는 타입
                    int a = 3;          -- 3 자료를 int 로 분류
                    double b = 3;       -- 3 자료를 double 로 분류
                vs
            2. 참조타입 : 배열/클래스/인터페이스 , new(인스턴스)자료 , 대문자로 시작 , Integer
                    -> 개발자 만든 타입 또는 라이브러리
        ...
        [ 자바의 기본 클래스 ]
            ...
            2. Class 클래스 : 클래스의 정보를 담는 클래스
                ...
                주요메소드
                    ...
                    2) .getFields()         : 지정한 인스턴스의 모든 멤버변수 반환
                       .getConstructor()    : 지정한 인스턴스의 모든 생성자 반환
            ...
            3. Wrapper 클래스 : 8가지 기본타입을 참조타입 사용
                ...
                주요메소드 :
                    1) .parseXXXX( "문자열" ) : 문자열 --> XXXX 타입변환 메소드
                    2) String.valueOf( 자료 ); * 자료 --> 문자열 반환

            4. LocalDate 클래스 : 시스템의 날짜/시간 갖는 정보 클래스
                특징 : 날짜/시간 저의/형식/세부/계산
                주요메소드
                    1. LocalDateTime.now() : 시스템의 현재 날짜/시간 을 갖는 LocalDateTime 객체 반환
                    2. LocalDateTime.of() (년, 월, 일, 시, 분, 초); : 지정한 값으로 날짜/시간을 갖는 LocalDateTime 객체 반환
                    3. .getYear() : 객체내 년 (int) 반환
        ...
        Object o1 = 3;                      // 정수를 Object로 분류 할 수 있다.
        Object o2 = 3.14;                   // 실수를 Object로 분류 할 수 있다.
        Object o3 = true;                   // 논리를 Object로 분류 할 수 있다.
        Object o4 = "유재석";                // 문자열을 Object로 분류할 수 있다.
        Object o5 = new Object();           //
        Object p6 = new int[]{1,2,3};       //
        ...
        System.out.println( o7.toString()); // day20.BookDto@27d6c5e0
        System.out.println( o8.toString()); // BoardDto{}
        System.out.println( o7 );   // day20.BookDto@27d6c5e0

            // 2. == 변수가 갖는 주소(위치) 비교 | .equals() : 주소가 갖는 객체 비교
        Object o9 = new BookDto();
        System.out.println( o9); //day20.BookDto@4f3f5b24
        Object o10 = new BookDto();
        System.out.println( o10); //day20.BookDto@15aeb7ab
        ...
        System.out.println(str1.equals(str2));// true
            // 3. .hashCode() : 객체의 주소(객체가 위치한 메모리 위치) 값을 정수로 반환
        System.out.println( str1.hashCode()); //50621969
        System.out.println( str2.hashCode()); //50621969
        System.out.println(o9.hashCode()); //1329552164
        System.out.println(o10.hashCode()); //363771819
        System.out.println(o11.hashCode()); //1329552164
        ...
        // 지정한 클래스경로에서 클래스로 로드/불러오기 메소드
        // -> 지정한 클래스경로에서 클랫를 로드 실패시 예외 발생
        try {
        ...
        // .getConstructors(); : 클래스/타입 의 모든 생성자명 반화
        // .getMethods(); : 클래스/타입 의 몯느 메소드명 반환
        ...
        System.out.println(localTime);//11:36:47.452416500
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println(localDateTime);//2025-07-25T11:37:13.760621800
        ...
        System.out.println(today); //2025년 07월 25일 11:43:57
        ...
        System.out.println(plusDateTime); //2025-08-04T11:48:33.253099600
        LocalDateTime minusDateTime = localDateTime.minusDays(30);
        System.out.println(minusDateTime); //2025-06-25T11:49:52.835692800
