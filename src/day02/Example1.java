...
public class Example1 {// class start
    ...
    public static void main(String[] args) { // main s
        ...
        //1. 자동 타입변환(묵시적)
            ...
            //(1) 메모리 크기가 작은 것 에서 큰 것으로 변환 가능
            //(2) 데이터의 손실이 적다.
        byte byteValue = 10;                // *10* 자료를 *byte* 타입으로 분류
        short shorValue = byteValue;        // byte -> short 가능!
        int intValue = shorValue;           // short -> int 가능!
