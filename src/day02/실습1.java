...
public class 실습1 { // 자바코드는 모두 클래스안에서 작성해야한다. // class start

    // main_엔터 : 실행할 코드는 모두 main 함수안에서 작성한다.
    public static void main(String[] args) {
        //[1]
        System.out.println(25); //!! 명렁어 끝에 ; 세미콜론 필수
        System.out.println("홍길동"); // ctrl+shift+f10

        //[2]
        int age = 31; //int(저장공간크기) age(공간이름) = (대입) 31(리터럴/자료);
