...
public class Example1 {//class s
    ...
    public static void main(String[] args) {//main s
            ...
            [ ArrayList ] 가변길이 , 다양한 메소드/기능 제공
                ...
                3. 사용법
                    ...
                    2) 요소 추가
                        ...
                        (2) 변수명.add(인덱스, 요소값);      : 지정한 인덱스를 요소 삽입
                        * 인덱스란? 배열 또는 리스트 내 저장된 (요소)값들 의 저장순서번호 , 0번 시작
                    3) 출력/반환
                        (1) 변수명                 : 전체 요소값 문자열 반환
               ...
               4. 리스트와 반복문 관계
                (1) 일반 반복문
                    ...
                    항목타입 변수명2 = 리스트변수명.get(i);}
                (2) 향상된 반복문
                    for( 항목타입 변수명2 : 리스트변수명){
                    }
        ...
        */
        ...
        System.out.println(리스트객체);
        // ! 중간에 요소 추가
        리스트객체.add(1,"박명수");     // * 1번 인덱스는 두번째 요소 자리 뜻
        System.out.println(리스트객체);
        ...
        // [5] .size( ); : 리스트의 크기 확인하기 vs 배열에서 사용한 .length 비슷하다.
        ...
        //2) Member 타입/클래스 의 객체 3개를 저장할 ArrayList 객체 생성
        ArrayList<Member> memberList = new ArrayList<>(); // < 꺽은 괄호에는 리스트/목록 내 저장할 항목의 타입
        //3) 리스트에 객체들을 저장하기.
        memberList.add(m1);
        memberList.add(m2);
        memberList.add(m3);
