...
//        alp.add("A"); alp.add("B"); alp.add("C"); alp.add("D"); alp.add("E");
//        alp.remove(2);
...
//        List.add("자바"); List.add("파이썬"); List.add("C++");
//        List.add(1, "자바스크립트");
...
//        Book book1 = new Book("어린왕자", "책");
//        Book book2 = new Book("신데렐라", "책1");
//        Book book3 = new Book("흥부와놀부", "책3");
//
