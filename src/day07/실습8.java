...
//
        Greeter g1 = new Greeter();//객체 생성
        g1. greet("유재석");//객체내 메소드 호출
        //"유재석" : 인수/인자 값은 매소드의 매개변수에 대입된다.
...
//
        ...
        int result3 = s1.add( 3, 5 ); // 인자/인수값 : 3 , 5
...
//        재고를 차감하는 sell 메소드를 정의하세요. 이 메소드는 재고가 충분하면 재고를 줄이고
//        true를, 부족하면 "재고 부족" 메시지를 출력하고 false를 반환합니다.
//        2. main 함수에서 Product 객체를 생성하고 초기 재고를 10으로 설정한 뒤,
//        sell 메소드를 호출하여 구매를 시도하고 결과를 확인하세요.
//
        Product pro = new Product();
        boolean result7 = pro.sell(5);
