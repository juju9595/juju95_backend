        ...
        /*
            [ 클래스 외 객체 ]
                ...
                * 자바의 모든 코드는 컴파일은 클래스 단위로 컴파일 한다. *
                5) 생활속 예시
                    (1) 학생 객체 만들기
                        1. 클래스 정의한다.    즉] 속성과 기능 만들기 --> 특징, 이벤트 만들기
               ...
               6)사용법
                    ...
                    < 객체 내 멤버변수 값 수정 >
                        변수명.멤버변수 = 새로운값
                    < 객체 내 멤버변수 추가 / 삭제 불가능 >
                        - 실행 도중에 클래스 정보를 수정할 수 없다. 단점] 유연성이 떨어짐
        */
        ...
        //[8] 붕어빵 객체 만들기
            ...
            // 3) 객체와 배열의 관계 : 배열은 동일한 타입/클래스 데이터/객체 여러개 저장
...
class Student{// 클래스란? 객체를 만드는 코드가 아닌 객체를 만들기 위해 객체내 필요한 속성과 기능을 설계/정의
