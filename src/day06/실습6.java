...
//                Arrays.toString()을 사용하여 배열의 모든 요소를 한 번에 출력하세요.
        ...
        System.out.println(Arrays.toString(season)); //Arrays.toString()을 사용하여 배열의 모든 요소를 한번에 출력
//
...
//        선언 코드: String[] fruits = {"사과", "바나나", "포도", "딸기"};
        ...
        //(2) 향상된 for문, for(배열타입 반복변수명 : 배열변수명) {}
...
//                선언 코드: int[] scores = {77, 82, 100, 54, 96};
        ...
        for(int score : scores2){
            if(score == 100){
                System.out.println("100점 만점자를 찾았습니다!"); break; } // 만약에 배열내 요소가 100점이면 반복문 종료
    }//for e
...
//        System.out.println(">>상품명:");       String name = scan.next();
...
//                if(stock[index] >= count){// 6) 만약에 index번째 재고보다 입력받은 재고가 더 크면
...
//        }//for e
//        //9) 상태변수에 따른 출력문
//        if (check == 0) {System.out.println("없는 상품입니다.");}
//        else if (check == 1) {System.out.println("구매완료!");}
//        else if (check == 2) {System.out.println("재고가 부족합니다.");}
