...
public class Example1 { //class s
    public static void main(String[] args) {//main s
        /*
            [ 배열 ]
                 ...
                 3. 사용법
                    ...
                    2) 호출
                        (1) 변수명                         ,       배열(객체)의 주소값
                        (2) Arrays.toString( 변수명 );     ,   배열내 요소 값 반환
                        (3) 변수명[인덱스]
                    ...
                    4) 삭제/추가 * 특정한 요소 삭제/추가 는 존재하지 않는다. 자바 배열은 *고정길이* 이므로 중간에 요소 총 개수 변경할 수 없다.
                    5) 배열과 반복문
                        (1) 일반 for문
                        for( int index = 0 ; index <= 배열변수명.length -1 ; index++){
                            타입 변수명 = 배열변수명[index];
                        }
                        (2) 향상된 for문, 인텍스 없이 배열내 요소값 하나씩 변수에 대입 반복
                            for( 타입 변수명 : 배열변수명){
        ...
        //[3] 배열의 주소값 반환
        System.out.println(array1); //[@4c873330 : 객체의 주소(컴퓨터가 사용하는 메모리 위치정보)값
