...
public class Example1 {
    public static void main(String[] args) {
        ...
        /*
            [ 예외 처리 ]
                ...
                3. 예외 종류
                    ...
                    -입출력, 네트워크, 파일, JBDE(자바-DB연동), 주로 자바외부 통신 : Class.forName, Thread.sleep
                    2) 실행 예외 : 컴파일(실행)될때 예외 처리 코드 여부 검사 하지않는 예외 , 개발자의 (경험) 의존도 크다.
                ...
                5. 예외 클래스
                    Exception : 모든 예외들의 상위 클래스
                        ...
                        - InterruptedException    : 흐름을 중단 되었을때 발생되는 정보를 저장하는 클래스
        ...
        // [1] 일반 예외 : 에외가 있던/없던 무조건 예외처리 해야한다.
        ...
        try {
            String str1 = "강호동";
            System.out.println(str1.length()); //"문자열".lenght() : 문자열 같이 반환 함수
        ...
        try {
            ...
            String str4 = "1aa";    // 문자 laa 저장, laa 숫자 x
        ...
        try {
            int[] intArray = {1, 2, 3};
            System.out.println(intArray[0]); //0번 인덱스
...
//            System.out.println("[예외발생6] 없는 인덱스 입니다."+e); //[예외발생6] 없는 인덱스 입니다.java.lang.ArrayIndexOutOfBoundsException: Index 4 out of bounds for length 3
        ...
        //[7] 실행예외 : InputMismatchException : 입력 데이터 타입이 일치 하지 않을때 예외
        try {
        ...
        // - 주의할점2: Exception 클래스는 모든 예외를 처리 하므로 다중 catch 맨 아래에서 정의한다.
