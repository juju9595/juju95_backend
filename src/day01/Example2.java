...
public class Example2 { // class start : 모든 자바코드는 클래스안에 작성한다.
    ...
    public static void main(String[] args) { // main start
        ...
        // JS: console.log() * JS에서는 ;(세미콜론) 선택이지만. 자바는 무조건 명령어 끝에 ; 넣는다.
            //sout + 엔터(자동완성)
        //(4) main함수 실행 : ctrl+shfit+f10 또는 실행버튼
        ...
        System.out.println(bool2);
            ...
            // 2. char 타입: '작은따옴표 로 감싼 문자1개 저장
        char ch1 = 'A';
        //char ch2 = 'ABC'; // 불가능. 문자열(문자여러개)
        //char ch3 = "ABC"; // "" 감싼 자료는 불가능
        ...
        System.out.println(s1);
            //6. int 타입 : 정수 +=21억정도          4바이트, 리터럴*
        int i1 = 210000000;
        //int i2 = 300000000;     // 불가능: 저장 허용 범위 벗어남.
        System.out.println(i1);
            //7. long 타입 : 정수 +-21억정도 이상     8바이트, 리터럴뒤에 L/l
        //long l1 = 300000000;      // 불가능 : 키보드로 입력한 모든값은(리터럴) 정수가 INT 라서
        long l2 = 3000000000L;
        ...
        //*******주의할점 : double(기본타입) 과 Double(참조타입) ***************
