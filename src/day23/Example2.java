    ...
    public static void main(String[] args) {
        /*
            [ 컬레션 프레임워크2 ]
                ...
                Set 인터페이스   : 집합구조 , 인덱스 없다. 중복허용하지 않는다(자료가식별자) + 중복없는 집합
         */
        // [1] HashSet 객체 생성
        ...
        System.out.println(set1.contains("강호동"));
            // 4) .remove(자료) : 집합 내 자라ㅛ가 존재하면 삭제 없으면 삭제 안함.
        set1.remove("강호동");
        System.out.println(set1);
            //5) .isEmpty() : 집한 내 자료가 하나도 없으면 true, 1개이상이면 false 반환
        ...
        // 2) 향상된 For문 : for( 타입 반복변수명 : 리스트/집합명){실행문}
        for(String str : set1){
        ...
        TreeSet<Integer> treeSet = new TreeSet<>();
            treeSet.add(10); treeSet.add(20); System.out.println(treeSet);
        // 3) LinkedHashSet : 중복없는 여러개 요소 저장 + 링크구조 + 순서(인텍스없는) 보장 + 느리다.
