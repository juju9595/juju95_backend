    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            ** 다형성 ** :  다양한 타입을 가지는 성질 , extends / implements 키워드 구조관계
            [ 컬렉션 프레임워크 ]
                - 컬레션(수집) 프레임(틀) 워크(작업) : 자료수집 방법 (=자료구조)
        ...
        // [2] List 인터페이스 주요 메소드
            //1).add(자료) : 리스트내 지정한 자룔르 마지막 요소 추가
        list2.add("유재석");
        list2.add("강호동");
        list2.add("신동엽");
        list2.add("유재석"); //중복 허용.
        ...
        list2.set(0,"유재석2");
        System.out.println(list2);
            // 3) .get(인텍스) : 리스트내 지정한 인덱스의 자료 호출/반환
        String result = list2.get(2);// '서장푼' 반환
        ...
        System.out.println(bool);
            // 6) .indexOf(자료) : 리스트내 지정한 자료의 인텍스 반환, 없으면 -1
        ...
        // Vector : 배열 구조로 사용되는 List 구현체 + 메소드 동기화(멀티 스레드 플랫폼)
        Vector<Integer> vector = new Vector<>();
        // LinkedList : 링크(체인/꼬리연결) 구조로 사용되는 List 구현체 + 중간 삽입/삭제 효율성 극대화
            // 배열구조 : [5] [4] [7] [10]
                //        0   1   2   3
                // 만약에 1번 인덱스가 삭제되면 2/3 인덱스는 한칸씩 이동
