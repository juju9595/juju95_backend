    ...
    public static void main(String[] args) {//main s
        /*
            ...
            [ 상속 ]
                ...
                3. 키워드 : extends(확장, 연장뜻)
                4. 장점 : 1.유지보수 2.계층표현 3.재사용 4.**다형성**
                5. 사용법 : class 하위클래스 extends 상위클래스명{ }
                ...
                7. 다형성 : 다양한 형식/타입을 갖는 성질
                    1)자동(묵시적)타입변환
                        ...
                        (2) 창조타입
                            ...
                            가능 조건] extends 상하/부모/계층 관계일때만 가능하다.
         ...
         */
        동물 animal = new 동물();//[1] 동물 클래스로 객체1개
        animal.name = "강아지";
        animal.show();          //강아지

        // [2] 조류 클래스 로 객체1개
        조류 bird = new 조류();
        // --> extends 란? 상위클래스로부터 멤버변수/메소드 하위클래스가 사용
        bird.name = "비둘기";      // 조류 클래스 존재하지 않는 멤버변수
        bird.show();              // 조류 클래스 존재하지 않는 메소드

        // [3] 참새 클래스 로 객체 1개 , 참새의 부모 --> 조류 --> 동물
        참새 sparrow = new 참새();
        // --> 상위클래스의 상위클래스 로부터 멤버변수/메소드
        sparrow.name = "참새1";
        sparrow.show();

        // [4] 닭 클래스로 객체1개, 닭의 부모 ---> 조류 ---> 동물
        닭 chicken = new 닭();
        chicken.name = "닭1";
        chicken.show(); //닭1
