...
public class Example1 {//class s
    public static void main(String[] args) {//main s
        ...
        //만일 상위타입/하위타입내 동일한 멤버변수명 존재할때 *현재 타입 우선*
        ...
        //오버로딩 vs 오버라이팅( 상위클래스로부터 메소드를 재정의)
        // 주의할점 : 메소드가 동일할때 오버라이딩 메소드 *최우선*
        obj2.showValue(); // obj2(하위타입) 메소드 실행
        obj3.showValue(); // obj3(상위타입) 일때 *태생타입의 메소드 실행 / 하위타입 메소드 실행
        상위클래스 obj4 = obj2;
        obj4.showValue(); // obj4(상위타입)일때 '태생'타입 매소드 우선
