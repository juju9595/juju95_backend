...
public class 실습4 {//class s
    public static void main(String[] args) {//main s
        // 1. 프롬프트/명령어
    Scanner scan = new Scanner(System.in);// 1). Scanner 객체 생성하여 변수에 저장
//        int a = scan.nextInt();    // 2). Scanner 이용하여 int 정수 두개를 입력받아 변수에 저장
//        int b = scan.nextInt();
//        int z = a + b;    // 3). 입력받은 두 변수의 값을 더한 결과를 변수에 저장
//        if( z >= 90){
//            System.out.println("성공");  // 4). 만약에 더한값이 90점 이상이면 '성공' 아니면 '실패'
//        }else {
//            System.out.println("실패");  // 5). console 출력한다.
//        }
...
/*
[문제 5] Scanner를 이용해 주민등록번호 13자리(-포함)를 문자열로 입력받습니다. 성별을 나타내는
8번째 숫자가 '1' 또는 '3'이면 '남자'를, '2' 또는 '4'이면 '여자'를 출력하는 프로그램을 작성하시오.
        ...
        // 주민등록번호 : 문자열(String)
        System.out.println("주민등록번호(-포함) 13자리를 입려고하세요:");
        String number = scan.next();
        char num1 = number.charAt(7);
...
/*
 [문제 6] Scanner를 이용해 게임 점수를 정수로 입력받아, 아래 기준에 따라 지급될 상품을 출력하는 프로그램을 작성하시오.
        ...
        System.out.println("게임점수:");
        int score2 = scan.nextInt();
        if(score2 >= 900) {
            System.out.println("A급 경품");
        }else if(score2 >= 700){ // 앞에 조건을 충족할 경우 해당 조건은 무시 (900점 이상)
 ...
 */
        ...
        if(price >= 50000){
            System.out.println((int)(price * 0.9)+"원"); //1 :100%, 0.1 : 10%, 0.5 : 50%, 0.01 ; 1%
        } else if (price >=30000) {
        ...
        */
        ...
        System.out.println("세 번째 정수:");
        int score3 = scan.nextInt();
        int max = score1; // 첫번째 입력값을 가장 큰수로 임의 지정
...
*/
        ...
        플레이어1 승리
*/
        System.out.println("플레이어1 0가위 or 1바위 or 2보 :");
        int p1 = scan.nextInt();
        System.out.println("플레이어2 0가위 or 1바위 or 2보 :");
        int p2 = scan.nextInt();
        //방법1 : p1 이기는 조건(p1==0 && p2==2 , p1==1 && p2==0, p1==2 & p2==1)
