package homework.src.project.view; // 패키지명

import homework.src.project.controller.*;
import java.util.InputMismatchException;
import java.util.Scanner;

import static homework.src.project.controller.Member_HeadController.currentMno;
...
public class TotalView {
    ...
    // Member_HeadDController 싱글톤 불러오기
