...
public class Example1 {//class s
    ...
    public static void main(String[] args) {//main s
        ...
        //System.out.println(a.비공개변수); //오류발생 : 해당 클래스에서만 가능
        //System.out.println(a.일반변수); //오류발생: 같은 패키지
